    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/plugins/codeEditor").Include(
                      ...
                      "~/Scripts/plugins/codemirror/mode/sql/sql.js",
                      "~/Scripts/plugins/codemirror/mode/htmlembedded/htmlembedded.js",
                      "~/Scripts/plugins/codemirror/addon/display/autorefresh.js"));
