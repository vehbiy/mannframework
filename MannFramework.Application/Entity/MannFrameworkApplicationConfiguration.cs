...
{
    public static class MannFrameworkApplicationConfiguration
    {
        ...
        static MannFrameworkApplicationConfiguration()
        {
            MannFrameworkConfigurationManager.SetConfigurationValues(typeof(MannFrameworkApplicationConfiguration));
        }
    }
}
